    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-lg text-brand-dark/80 mb-6 leading-relaxed">
            U belt ons. U spreekt met ons. Wij regelen het. Dat is het. Geen detour via verschillende aannemer, geen verwarring over wie voor wat verantwoordelijk is. Wij dragen dat voor u.
          </p>
